...
export function MarkdownFileViewer({ entry, onClose }: FileViewerProps) {
  ...
  const previewHtml = useMemo(
    () => (text != null && entry.token ? renderMarkdown(text, entry.token) : ''),
    [text, entry.token],
  );
      ...
      <div className="file-viewer-panel file-viewer-panel-doc">
        ...
        <div className="file-viewer-body">
          ...
          {text !== null && mode === 'preview' ? (
            <article
              className="doc-preview markdown-preview"
